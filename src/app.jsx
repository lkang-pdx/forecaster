...
var query = ''; // Expects something like this ?city=Portland,Paris,Berlin,Madrid
...
var Weather = React.createClass({
    ...
    componentWillMount: function() {
        ...
        if (query !== undefined) {
            ...
            cities[0] = 'Portland'; // Set Portland as the default city
        }
    ...
    updateData: function() {
        ...
        this.setState({
            ...
            temp: (Math.round(citiesWeather[currentCity].main.temp - 273.15)*1.8)+32, // Kelvin to Celcius
